...
from data_reader import BioSummDatasetReader

def parse_train_args( recover = False, force = True):
...
#             )
    ...
    def from_partial_objects(
        ...
        # construct vocabulary from instances or transformers (PretrainedTokenizer)
        ## instances
        instance_generator = (
            instance
...
if __name__=="__main__":
    ...
    args.param_path = 'config.jsonnet'
    main(args)
